...
const formSchema = z.object({
	...
	description: z
		.string()
		.min(10, "Please provide more detail in the description"),
		...
		<div className="max-w-3xl mx-auto space-y-6 pb-10">
			<div className="flex items-center gap-4">
				...
				<div>
					...
					<p className="text-muted-foreground mt-1">
						Submit a new safety report, near-miss, or observation.
					</p>
				</div>
			</div>
			...
			<div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 flex items-start gap-3">
				...
				<div className="text-sm text-blue-800 dark:text-blue-200">
					...
					<p>
						If this is an active emergency or involves serious injury, please
						contact emergency services immediately before completing this form.
				...
				<Form {...form}>
					<form onSubmit={form.handleSubmit(onSubmit)}>
						<CardHeader>
							...
							<CardDescription>
								Provide accurate and objective information about the event.
							</CardDescription>
						</CardHeader>
						<CardContent className="space-y-6">
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<Input
												placeholder="e.g. Slip hazard near loading dock 3"
												{...field}
											/>
										</FormControl>
										<FormMessage />
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel>
											Immediate Corrective Actions Taken (Optional)
										</FormLabel>
										<FormControl>
											<Textarea
