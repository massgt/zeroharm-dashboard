...
import { Shield, Activity, Upload, Users, Search, Bell, Settings } from "lucide-react";
    ...
    <div className="flex h-screen w-full bg-background overflow-hidden">
      ...
      <aside className="w-64 flex flex-col bg-sidebar text-sidebar-foreground border-r border-sidebar-border hidden md:flex shrink-0">
        <div className="h-16 flex items-center px-6 border-b border-sidebar-border">
          <Shield className="h-6 w-6 text-primary mr-3 shrink-0" />
          <div>
            <div className="font-bold tracking-tight text-base leading-tight">SAP Monitor</div>
            <div className="text-[10px] text-sidebar-foreground/50 leading-tight">PT. Minergo Visi Maxima</div>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-sidebar-border">
          <div className="flex items-center cursor-pointer hover:bg-sidebar-accent p-2 rounded-md transition-colors">
            ...
            <div className="flex-1 overflow-hidden">
              ...
              <div className="text-xs text-sidebar-foreground/60 truncate">HSE Officer</div>
            </div>
          </div>
        </div>
      </aside>
